...
export function attachLiveOdds(picks: MarketPick[], rawOdds: LiveRawOdds | null): void {
  ...
  for (const pick of picks) {
    ...
    switch (pick.market) {
      ...
      case 'AH_HOME_MINUS_1': odd = rawOdds.ah_away_plus_1; break; // SWAP: API away+1 = home-1 odds
      case 'AH_AWAY_PLUS_1': odd = rawOdds.ah_home_minus_1; break; // SWAP: API home-1 = away+1 odds
      case 'AH_HOME_PLUS_1': odd = rawOdds.ah_away_plus_1 ? (1 / (1 - 1/rawOdds.ah_away_plus_1)) : undefined; break; // Derive from complement
      case 'HTFT': {
