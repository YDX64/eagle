 ...
 * Two source tabs: "Algoritmamız" (our engines) and "AwaStats" (external).
 */
        ...
        {source === 'api' && (<>
          {api ? (
            <div className="space-y-4">
              ...
              {apiP?.winner && (
                <div className="glass-panel rounded-3xl p-6 glow-border-primary">
                  <h4 className="font-headline text-xs font-bold text-primary uppercase tracking-[0.2em] mb-3">AwaStats Prediction</h4>
            ...
            <div className="glass-panel rounded-3xl p-8 text-center">
              ...
              <p className="font-body text-sm text-on-surface-variant">AwaStats tahmin verisi bu maç için mevcut değil.</p>
            </div>
          )}
        </>)}
      </main>
          ...
          {source === 'ours' ? (
            ...
            api ? (
              ...
              <div className="glass-panel rounded-3xl p-12 text-center">
                ...
                <p className="font-headline text-lg text-on-surface-variant">AwaStats tahmin verisi mevcut değil</p>
              </div>
            )
          )}
