...
export function MatchCard({ match, onViewPrediction, showPrediction = true }: MatchCardProps) {
  ...
  return (
    <Card className="h-full border-2 hover:border-primary/40 hover:shadow-lg hover:shadow-violet-200/30 dark:hover:shadow-violet-500/10 transition-all duration-300 group bg-gradient-to-br from-card via-card to-violet-50/30 dark:to-violet-950/20">
      <CardContent className="p-4 h-full flex flex-col">
        ...
        <div className="mt-auto">
          {/* Action Button — ProBet brand gradient */}
          {showPrediction && isUpcoming && onViewPrediction && (
            <Button
              onClick={() => onViewPrediction(match.fixture.id)}
              className="w-full mb-2 h-8 text-xs bg-gradient-to-r from-violet-500 to-blue-600 hover:from-violet-600 hover:to-blue-700 text-white shadow-sm hover:shadow-md transition-all duration-200"
              size="sm"
            >
