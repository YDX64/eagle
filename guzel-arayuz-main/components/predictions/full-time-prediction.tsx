...
import OddsBox from "@/components/ui/odds-box";
...
interface FullTimePredictionProps {
  prediction: {
...
export default function FullTimePrediction({ prediction }: FullTimePredictionProps) {
  return (
    <PredictionCard>
      <SectionTitle icon={<Trophy />} title="FULL TIME" />
