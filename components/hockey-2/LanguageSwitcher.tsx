...
import { LOCALES, type Locale } from "@/lib/hockey-2/i18n";
...
export default function LanguageSwitcher() {
  ...
  return (
    <div ref={ref} className="relative">
      ...
      {open && (
        <div className="absolute right-0 top-full mt-1 z-50 min-w-[160px] bg-card border border-border rounded-xl backdrop-blur-sm rounded-lg border border-border/40 shadow-xl overflow-hidden">
          {LOCALES.map((loc) => (
            <button
              key={loc.code}
              onClick={() => {
